...
import {currentKeys, encryptData} from '/@/lib/encrypt';
  import { refreshKeys, currentAlgorithm } from '/@/lib/encrypt';
  import { smartAxios } from '/@/lib/axios';
import {message} from "ant-design-vue";
  ...
  onMounted(async () => {
    try {
      ...
      message.error(`初始化密钥失败: ${e.message}`);
    }
  });
